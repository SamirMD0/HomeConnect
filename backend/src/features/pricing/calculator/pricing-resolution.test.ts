...
const product = { id: 'p', name: 'AC', model: 'A1', barcode: null, brand: null, price: null, discount: null, costPrice: new Decimal(300), pricingPresetId: preset.id, pricingPreset: preset, useCustomPricing: false, customExpensePercent: null, customProfitPercent: null, customDiscountBufferPercent: null, customInstallmentMarkupPercent: null, customDownPaymentPercent: null, customInstallmentMonths: null, customCalculationMode: null, isActive: true, notes: null, createdById: 'u', updatedById: null, createdAt: new Date(), updatedAt: new Date() };

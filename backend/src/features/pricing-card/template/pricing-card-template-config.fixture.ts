export const minimumTemplateConfig = {
  ...
  body: { title: { show: true, maxLines: 2 as const, fontScale: 1 }, detailsFontScale: 1, detailsBoldBlack: false, model: { show: true, prefix: 'Model:' }, dimensions: { show: true }, specs: { show: true, maxRows: 4 }, image: { show: false, columnWidthPct: 0 } },

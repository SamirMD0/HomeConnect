...
WITH line_state AS (
  SELECT
    ...
    CASE
      ...
      WHEN o."orderDate" < (opening."createdAt" AT TIME ZONE 'Asia/Beirut')::date THEN 'PREDATES_OPENING_COUNT'
...
WITH opening_dates AS (
  SELECT "productId", ("createdAt" AT TIME ZONE 'Asia/Beirut')::date AS "openingBusinessDate"

-- HomeConnect v1.1.1 product image additive repair script.
...
-- product image feature, or when the v1.1.1 installer was applied to a business
...
BEGIN
  ...
  INSERT INTO "_prisma_migrations" (
    ...
    'Applied manually by release/1.1.1/repair-v1.1.1-product-image-business-pc-safe.sql',
    NULL,
    now(),
    1
  );

...
export const ProductLabelPage: React.FC = () => {
  const { id = '' } = useParams(); const navigate = useNavigate(); const [showCode, setShowCode] = useState(true); const [showPrice, setShowPrice] = useState(true); const label = useProductLabel(id, showCode, showPrice); const [copies, setCopies] = useState(1); const [dimensions, setDimensions] = useState(loadProductLabelDimensions);

...
export const ProductLabelPage: React.FC = () => {
  const { id = '' } = useParams(); const navigate = useNavigate(); const [showCode, setShowCode] = useState(false); const label = useProductLabel(id, showCode); const [copies, setCopies] = useState(1); const [dimensions, setDimensions] = useState(loadProductLabelDimensions);

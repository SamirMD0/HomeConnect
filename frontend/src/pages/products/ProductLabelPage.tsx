...
export const ProductLabelPage: React.FC = () => {
  const { id = '' } = useParams(); const navigate = useNavigate(); const label = useProductLabel(id); const [copies, setCopies] = useState(1);

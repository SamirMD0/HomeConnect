...
const template = (overrides: Partial<PricingCardTemplate> = {}): PricingCardTemplate => ({
  ...
  config: {
    ...
    body: { title: { show: true, maxLines: 2, fontScale: 1 }, model: { show: true }, dimensions: { show: true }, specs: { show: true, maxRows: 3 }, image: { show: false, columnWidthPct: 0 } },
    ...
    appearance: { marginMm: 3, innerGapMm: 1.5, borderPx: 1, sectionDividers: true, fontScale: 1, orientation: 'landscape' },
  },

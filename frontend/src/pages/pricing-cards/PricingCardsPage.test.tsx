...
const template = (overrides: Partial<PricingCardTemplate> = {}): PricingCardTemplate => ({
  ...
  config: {
    ...
    body: { title: { show: true, maxLines: 2, fontScale: 1 }, detailsFontScale: 1, detailsBoldBlack: false, model: { show: true, fontScale: 1 }, dimensions: { show: true }, specs: { show: true, maxRows: 3 }, image: { show: false, columnWidthPct: 0 } },

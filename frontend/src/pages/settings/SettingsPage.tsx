        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Create and edit the layout templates every printed card is bound to.</p>
            </div>
          </div>
          <Link to="/settings/pricing-cards" className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white">Open</Link>
        </div>
      </section>
